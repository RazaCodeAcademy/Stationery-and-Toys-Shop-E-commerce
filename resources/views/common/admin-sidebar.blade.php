...
<div class="l-navbar" id="navbar">
    ...
    <nav class="myNav">
        <div>
            <div class="nav__list">
                <a href="{{ route('dashboard.index') }}" class="nav__link active_item" title="Dashboard">
                ...
                <a href="{{ route('customers.index') }}" class="nav__link">
                    <i class="fa fa-users nav__icon" aria-hidden="true" title="Customers"></i>
